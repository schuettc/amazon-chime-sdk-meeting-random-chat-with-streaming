...
var createMediaCapturePipelineCommandInput: CreateMediaLiveConnectorPipelineCommandInput =
  {
    Sources: [
      {
...
async function createStream(meetingId: string) {
  ...
  if (
    ...
    createMediaCapturePipelineCommandInput!.Sinks![0]!.RTMPConfiguration!.Url = `rtmps://${createChannelResponse.channel.ingestEndpoint}:443/app/${createChannelResponse.streamKey.value}`;
